...
for j in range(N_G):
    ...
    if plot_every_sweep:
        ...
        plt.title(f"2N7000A NMOS I_D vs V_D for V_G = {V_G}")
...
np.savez("2N7000A_IV_Data_ID_VD.npz", V_D_V_G_array=V_D_V_G_array, I_D_V_G_array=I_D_V_G_array, V_G_initial=V_G_initial, V_G_inc=V_G_inc)
...
plt.title("2N7000A NMOS IV Characteristics")
plt.grid(True); plt.legend(); 
plt.show()
###########################################################################################################
ser.close()
