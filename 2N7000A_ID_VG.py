...
#Save the data
V_D_array = np.linspace(V_D_initial, V_D_final, V_D_inc)
np.savez("2N7000A_IV_Data_ID_VG.npz", V_G_V_D_array=V_G_V_D_array, I_D_V_D_array=I_D_V_D_array, V_D_array=V_D_array)
