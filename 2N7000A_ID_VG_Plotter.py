...
Imax = 0; Imin = 0;
for j in range(N_D):
    plt.plot(V_G_V_D_array[j], I_D_V_D_array[j], label = f"{V_D_array[j]}")
...
plt.title("2N7000A I)D vs V_D Characteristics")
